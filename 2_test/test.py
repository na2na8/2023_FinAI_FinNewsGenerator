...
if __name__ == "__main__" :
    ...
    parser.add_argument('--mode', type=str, default="numbers2", help="[keyword, filing, both1, both2, numbers1, numbers2]")
    parser.add_argument('--randomseed', type=int, default=42)
    parser.add_argument('--max_length', type=int, default=512)
    parser.add_argument('--ckpt_path', type=str, default='./checkpoint')
    parser.add_argument('--tensorboard', type=str, default='numbers2')
